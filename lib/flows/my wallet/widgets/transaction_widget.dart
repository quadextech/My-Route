    ...
    return Row(
      children: [
        CircleAvatar(
          ...
          child: Icon(
             widget.type =='withdrawal'? Icons.arrow_outward: Icons.arrow_downward_outlined,
          ...
          children: [
            Column(
              ...
              children: [
                ...
                Text(
                 widget. status,
                  style: body4(widget.status == 'Processed'?successColor: widget.status == 'Pending'? warningColor :errorColor ),
                ),
              ],
            ),
            ...
            Column(
              ...
              children: [
                ...
                Text(
                  '12:00PM',
                  style: body4(const Color.fromARGB(255, 218, 210, 210)),
                )
              ],
            )
          ],
