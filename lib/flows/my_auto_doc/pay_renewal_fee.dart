              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child:
                        Text('Choose where to pay from', style: body2(black, TextDecoration.none)),
                  ),
                  SizedBox(
                    height: 10,
                  ),
            ...
            child: CustomPopUpContainer(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                      child: Text(
                    'Your Drivers license renewal is being processed!',
                    style: body3(black, TextDecoration.none),
                  )),
                  SizedBox(
                    height: 30,
          ...
          return SingleChildScrollView(
            child: CustomPopUpContainer(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Please enter your MyRoute Password',
                      style: body2(black,  TextDecoration.none)),
                  SizedBox(
                    height: 30,
                  ),
                  ...
                  RichText(
                    ...
                    TextSpan(
                        ...
                        style: body3(greenColor, TextDecoration.none)),
                  ])),
                  SizedBox(
                    height: 30,
                  ),
          ...
          child: Column(
            children: [
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text('Reg no: AE451KEH',style: body4(
                          black,TextDecoration.none
                        ),),
                        ],
                      ),
              ...
              isscuccess
                  ? Center(
                    child: Text(
                        "Your Driver's License is being processed !",
                        style: body2(
                          Colors.red,
                          TextDecoration.none
                        ),
