...
class AutoDocHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Text('View your registered Cars and their registration details', style: body4(black, TextDecoration.none),),]),
            ...
            Row(
                children: [
                  ...
                  const SizedBox(width: 20,),
                  Text('Monitor the expiry dates of your Car documents', style: body4(black, TextDecoration.none),),]),
            const SizedBox(height: 20,),
            Row(
                children: [
                  Padding(padding: const EdgeInsets.only(bottom: 22),
